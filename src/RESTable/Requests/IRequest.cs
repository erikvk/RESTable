...
public interface IRequest<T> : IRequest where T : class
{
    ...
    ///     This delegate is used in GetInputEntities(). By default RESTable will generate entities by deserializing the
    ///     request
    ...
    /// <summary>
    ///     Gets a client data point for the current resouce. Data points assigned to the client of the request, for use with
    ///     RESTable
    ///     internally to pass custom data between operations, for example account or session information. Each resource can
    ///     have its
    ...
    /// <summary>
    ///     Sets a client data point for the current resouce. Data points assigned to the client of the request, for use with
    ///     RESTable
    ///     internally to pass custom data between operations, for example account or session information. Each resource can
    ///     have its
    ///     separate client data set, that is not available from other resuorces.
