...
public class ResourceFactory
{
    ...
    /// </summary>
    /// <returns></returns>
    private void ValidateAndBuildTypeLists(out List<Type> regularTypes, out List<Type> wrapperTypes, out List<Type> terminalTypes, out List<Type> binaryTypes)
    {
        ...
        (regularTypes, wrapperTypes, terminalTypes, binaryTypes, _) = ResourceValidator.Validate(resourceTypes);
    ...
    private void ValidateInnerResources()
    {
        ...
        foreach (var group in resourceGroups)
        {
            ...
            foreach (var innerResource in group) parentResource.AddInnerResource(innerResource);
        }
    }

    internal void BindControllers()
    {
        foreach (var (provider, controller, baseType) in typeof(Resource)
                     ...
                     }))
        {
            ...
            if (resourceProvider is null) continue;
