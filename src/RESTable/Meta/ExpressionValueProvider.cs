...
internal class ExpressionValueProvider
{
    ...
    {
        if (_setter is null) _setter = ExpressionReflectionDelegateFactory.Instance.CreateSet<object>(_memberInfo);
    ...
    {
        if (_getter is null) _getter = ExpressionReflectionDelegateFactory.Instance.CreateGet<object>(_memberInfo);
