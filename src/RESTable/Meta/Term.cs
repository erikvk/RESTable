...
public class Term : IEnumerable<Property>
{
    ...
    /// </summary>
    public T? FirstAs<T>() where T : Property
    {
        return First as T;
    }
    ...
    /// </summary>
    public T? LastAs<T>() where T : Property
    {
        return Store.LastOrDefault() as T;
    }
    ...
    private string GetKey(string componentSeparator)
    {
        return string.Join(componentSeparator, Store.Select(p => p.Name));
    }
    ...
    private string GetActualNameKey()
    {
        return string.Join(".", Store.Select(p => p.ActualName));
    }
    ...
    {
        return string.Equals(Key, other.Key) && IsDeclared == other.IsDeclared;
    }
