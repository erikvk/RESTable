...
public class DeclaredProperty : Property
{
    ...
    {
        return GetAttribute<TAttribute>() is not null;
    }
    ...
    {
        return (attribute = GetAttribute<TAttribute>()) is not null;
    }
    ...
    {
        return $"{Type.GetRESTableTypeName()}.{Name}";
    }

    /// <inheritdoc />
    public override bool Equals(object? obj)
    {
        return obj is DeclaredProperty p && p.MetadataToken == MetadataToken;
    }
    ...
    {
        public bool Equals(DeclaredProperty? x, DeclaredProperty? y)
        {
            return x?.Name == y?.Name;
        }

        public int GetHashCode(DeclaredProperty obj)
        {
