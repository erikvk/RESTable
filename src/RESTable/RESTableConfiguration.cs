...
namespace RESTable
{
    public class RESTableConfiguration
    {
        ...
        static RESTableConfiguration()
        {
            ...
            _RunningExecutablePath = System.Diagnostics.Process.GetCurrentProcess().MainModule?.FileName ?? "Unknown";
        ...
        public IReadOnlyList<string> ReservedNamespaces => _ReservedNamespaces;
