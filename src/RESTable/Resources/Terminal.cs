...
public abstract class Terminal
{
    ...
    [RESTableMember(hide: true)] public ITerminalResource TerminalResource { get; private set; } = null!;
    ...
    public virtual Task HandleTextInput(string input, CancellationToken cancellationToken)
    {
    ...
    /// </summary>
    [MethodNotImplemented]
    public virtual Task HandleBinaryInput(Stream input, CancellationToken cancellationToken)
    {
        throw new NotImplementedException();
    }
}