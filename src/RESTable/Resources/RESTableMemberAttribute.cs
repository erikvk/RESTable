...
public class RESTableMemberAttribute : Attribute
{
    ...
    /// <param name="hide">
    ///     Should this property be hidden in serialized output by default? It can still be added and queried
    ///     against.
    /// </param>
    ...
    /// <param name="excelReducer">
    ///     The name of an optional public ToString-like method, declared in the same scope as the
    ///     property, that reduces the property to an excel-compatible string.
    /// </param>
    /// <param name="replaceOnUpdate">
    ///     Should this object be replaced with a new instance on update, or reused? Applicable for
    ///     types such as Dictionaries and Lists.
    /// </param>
    ...
    /// <param name="required">
    ///     Should this member be required to have a value set in a condition in all requests to this
    ///     resource?
    /// </param>
    ...
    /// <summary>
    ///     Should this property be completely ignored by RESTable? Equivalent to using the .NET standard
    ///     IgnoreDataMemberAttribute
    /// </summary>
    public bool Ignored { get; }

    /// <summary>
    ///     A new name for this property, used by RESTable. Equivalent to using the .NET standard DataMemberAttribute
    ///     attribute.
    /// </summary>
