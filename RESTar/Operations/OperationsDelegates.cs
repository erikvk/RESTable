...
namespace RESTar.Operations
{
    ...
    /// </summary>
    /// <typeparam name="T">The resource type</typeparam>
    public delegate int Inserter<in T>(IEnumerable<T> entities, IRequest request) where T : class;
    ...
    /// </summary>
    /// <typeparam name="T">The resource type</typeparam>
    public delegate int Updater<in T>(IEnumerable<T> entities, IRequest request) where T : class;
    ...
    /// </summary>
    /// <typeparam name="T">The resource type</typeparam>
    public delegate int Deleter<in T>(IEnumerable<T> entities, IRequest request) where T : class;
}