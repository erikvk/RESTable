...
namespace RESTar.Requests
{
    ...
    /// </summary>
    public class ExternalServiceNotRESTar : Results.NotFound
    {
        internal ExternalServiceNotRESTar(Uri uri, Exception ie = null) : base(ErrorCodes.ExternalServiceNotRESTar,
            $"A remote request was made to '{uri}', but the response was not recognized as a RESTar service response", ie) { }
    }
}