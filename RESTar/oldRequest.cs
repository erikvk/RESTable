...
namespace RESTar
{
    ...
    //    {
    //        var ar = new RESTarRequest<T> {Unsafe = true, Limit = limit};
    ...
    //    public static int POST(Func<T> inserter) => new RESTarRequest<T>().POST(inserter);
    ...
    //    public static int POST(Func<IEnumerable<T>> inserter) => new RESTarRequest<T>().POST(inserter);
    ...
    //    {
    //        var ar = new RESTarRequest<T> {Unsafe = @unsafe, Limit = limit};
    //        ar.AddOrderBy(orderBy);
    //        ar.AddConditions(conditions);
    ...
    //        int limit = -1, (string key, bool descending)? orderBy = null)
    //    {
    //        var ar = new RESTarRequest<T> {Limit = limit};
    //        ar.AddOrderBy(orderBy);
    //        ar.AddConditions(conditions);
