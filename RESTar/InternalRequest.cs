...
namespace RESTar
{
    ...
    internal class InternalRequest<T> : IRequest<T>, IRequestInternal<T> where T : class
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="InternalRequest{T}"/> class
        /// </summary>
        /// <param name="conditions"></param>
        public InternalRequest(params Condition<T>[] conditions)
        {
        ...
        /// </summary>
        public InternalRequest<T> WithConditions(IEnumerable<Condition<T>> conditions)
        {
        ...
        /// Uses the given conditions, and returns a reference to the request.
        /// </summary>
        public InternalRequest<T> WithConditions(params Condition<T>[] conditions)
        {
            Conditions = conditions;
            return this;
        }
        ...
        /// Uses the given conditions, and returns a reference to the request.
        /// </summary>
        public InternalRequest<T> WithConditions(params (string key, Operators op, object value)[] conditions)
        {
        ...
        /// Uses the given conditions, and returns a reference to the request.
        /// </summary>
        public InternalRequest<T> WithConditions(string key, Operators op, object value) => WithConditions((key, op, value));
